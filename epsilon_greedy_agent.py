...
class BanditRewardsLog:
    def __init__(self):
        ...
        self.all_rewards = []
        self.record = defaultdict(lambda: dict(actions=0, rewards=0))

    def record_action(self, bandit, reward):
        self.total_actions += 1
        self.total_actions += reward
        self.all_rewards.append(reward)
        self.record[bandit.id]['actions'] += 1
        self.record[bandit.id]['rewards'] += reward
    ...
    def _get_current_best_bandit(self) -> Bandit:
        ...
        for bandit in self.bandits:
            ...
            if not bandit_record['actions']:
                ...
                estimates.append(bandit_record['rewards']/bandit_record['actions'])
